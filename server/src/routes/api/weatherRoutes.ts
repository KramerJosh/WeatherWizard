...
router.post('/', async (req: Request, res: Response) => {
  try {
    const { cityName } = req.body; // pull city name from the body of the request, and store in local variable
...
router.get('/history', async (req: Request, res: Response) => {
  try {
    console.log(req.json) // console logging to remove error for not calling req
